...
import { TheCastle4hr, TheCastle6hr, TheCastle8hr } from "./PayPalCheckOut";
...
{/* start of new row */}
                    ...
                    >
                        <ColDiv>
                        <h1 style={{fontSize:'4rem', fontWeight: '100', color: 'white'}} >The Toddler</h1>
                        <RowDiv>
                            
                            <ColDiv style={{ padding: '1rem' }}>
                                
                                <h2 style={{fontSize:'6rem', fontWeight:'100', color: 'white'}}>4hrs</h2>
                                <h2 style={{ color: 'white', fontWeight: '200', fontSize: '1.75rem' }}>$150 + taxes</h2>
                                <p style={{ textAlign: 'center' }}>Rental: $100</p>
                                <p style={{ textAlign: 'center' }}>Generator: $50</p>
                                <p style={{ textAlign: 'center' }}>Taxes at 9.5%</p>

                                <TheCastle8hr />
                            </ColDiv>
                            <ColDiv style={{ padding: '1rem' }}>
                            <h2 style={{fontSize:'6rem', fontWeight:'100', color: 'white'}}>6hrs</h2>
                                <h2 style={{ color: 'white', fontWeight: '200', fontSize: '1.75rem' }}>$250 + taxes</h2>
                                <p style={{ textAlign: 'center' }}>Rental: $200</p>
                                <p style={{ textAlign: 'center' }}>Generator: $50</p>
                                <p style={{ textAlign: 'center' }}>Taxes at 9.5%</p>
                                <TheCastle8hr />
                            </ColDiv>
                            <ColDiv style={{ padding: '1rem' }}>
                            <h2 style={{fontSize:'6rem', fontWeight:'100', color: 'white'}}>8hrs</h2>
                                <h2 style={{ color: 'white', fontWeight: '200', fontSize: '1.75rem' }}>$350 + taxes</h2>
                                <p style={{ textAlign: 'center' }}>Rental: $300</p>
                                <p style={{ textAlign: 'center' }}>Generator: $50</p>
                                <p style={{ textAlign: 'center' }}>Taxes at 9.5%</p>
                                <TheCastle8hr />
                            </ColDiv>
                        ...
                        <ColDiv>
                        <h1 style={{fontSize:'4rem', fontWeight: '100', color: 'white'}} >The Classic Castle</h1>
                        <RowDiv>
                            
                            <ColDiv style={{ padding: '1rem' }}>
                                
                                <img src={test2} style={{ width: '7rem',margin:'1rem' }} />
                                <h2 style={{ color: 'white', fontWeight: '200', fontSize: '1.75rem' }}>Pouncer</h2>
                            ...
                            <ColDiv style={{ padding: '1rem' }}>
                                ...
                                <h2 style={{ color: 'white', fontWeight: '200', fontSize: '1.75rem' }}>Classic Castle / Half Arch</h2>
                            ...
                            <ColDiv style={{ padding: '1rem' }}>
                                ...
                                <h2 style={{ color: 'white', fontWeight: '200', fontSize: '1.75rem' }}>Classic Castle / Full Arch</h2>
